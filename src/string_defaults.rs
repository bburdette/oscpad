...
var _bburdette$oscpad$SvgTouch$extractFirstRectTouchSE = F2(
	function (msg, rect) {
		...
		switch (_p2.ctor) {
			case 'SvgTouchStart':
				return A2(_bburdette$oscpad$SvgTouch$extractFirstTouchInRect, _p2._0, rect);
			case 'SvgTouchMove':
				return A2(_bburdette$oscpad$SvgTouch$extractFirstTouchInRect, _p2._0, rect);
			case 'SvgTouchEnd':
				return _elm_lang$core$Maybe$Nothing;
...
var _bburdette$oscpad$SvgButton$encodeUpdateMessage = function (um) {
	var outlist1 = _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'controlType',
...
var _bburdette$oscpad$SvgButton$UpdateMessage = F3(
	function (a, b, c) {
		return {controlId: a, updateType: b, label: c};
	});
...
var _bburdette$oscpad$SvgButton$jsUpdateMessage = A4(
	_elm_lang$core$Json_Decode$object3,
...
var _bburdette$oscpad$SvgSlider$encodeUpdateMessage = function (um) {
	...
	return _elm_lang$core$Json_Encode$object(outlist4);
};
...
var _bburdette$oscpad$SvgSlider$getLocation = F2(
	function (model, v) {
		var _p4 = model.orientation;
		if (_p4.ctor === 'Horizontal') {
			var _p5 = A2(_elm_lang$core$Json_Decode$decodeValue, _bburdette$oscpad$SvgSlider$getX, v);
			if (_p5.ctor === 'Ok') {
				return _elm_lang$core$Result$Ok(
					_elm_lang$core$Basics$toFloat(_p5._0 - model.rect.x) / _elm_lang$core$Basics$toFloat(model.rect.w));
			} else {
				return _elm_lang$core$Result$Err(_p5._0);
			}
		} else {
			var _p6 = A2(_elm_lang$core$Json_Decode$decodeValue, _bburdette$oscpad$SvgSlider$getY, v);
			if (_p6.ctor === 'Ok') {
				return _elm_lang$core$Result$Ok(
					_elm_lang$core$Basics$toFloat(_p6._0 - model.rect.y) / _elm_lang$core$Basics$toFloat(model.rect.h));
			} else {
...
var _bburdette$oscpad$SvgSlider$Spec = F3(
	function (a, b, c) {
		return {name: a, label: b, orientation: c};
	});
var _bburdette$oscpad$SvgSlider$jsSpec = A4(
	_elm_lang$core$Json_Decode$object3,
...
var _bburdette$oscpad$SvgSlider$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {name: a, label: b, cid: c, rect: d, srect: e, orientation: f, pressed: g, location: h, sendaddr: i, textSvg: j, touchonly: k};
										};
									};
								};
							};
...
var _bburdette$oscpad$SvgSlider$init = F4(
	function (sendaddr, rect, cid, spec) {
		var ts = function () {
			var _p8 = spec.label;
			if (_p8.ctor === 'Just') {
				return A3(_bburdette$oscpad$SvgThings$calcTextSvg, _bburdette$oscpad$SvgThings$ff, _p8._0, rect);
			} else {
				return _elm_lang$core$Native_List.fromArray(
					[]);
			}
		...
		return {
			ctor: '_Tuple2',
			_0: _bburdette$oscpad$SvgSlider$Model(spec.name)(
				...
				A4(
					...
					_elm_lang$core$Basics$toString(rect.y),
					_elm_lang$core$Basics$toString(rect.w),
					_elm_lang$core$Basics$toString(rect.h)))(spec.orientation)(false)(0.5)(sendaddr)(ts)(false),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _bburdette$oscpad$SvgSlider$UpdateMessage = F4(
	function (a, b, c, d) {
		return {controlId: a, updateType: b, location: c, label: d};
	});
...
var _bburdette$oscpad$SvgSlider$NoOp = {ctor: 'NoOp'};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$virtual_dom$VirtualDom$map,
				function (_p11) {
					return _bburdette$oscpad$SvgSlider$NoOp;
				},
				A2(
					_elm_lang$svg$Svg$g,
					_elm_lang$core$Native_List.fromArray(
...
var _bburdette$oscpad$SvgSlider$updsend = F3(
	function (model, mbut, loc) {
		var prest = !_elm_lang$core$Native_Utils.eq(
			mbut,
			...
			var um = A2(
				...
				_bburdette$oscpad$SvgSlider$encodeUpdateMessage(
					A4(
						...
						model.cid,
						mbut,
						_elm_lang$core$Maybe$Just(bLoc),
						_elm_lang$core$Maybe$Nothing)));
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
...
var _bburdette$oscpad$SvgSlider$jsUpdateMessage = A5(
...
var _bburdette$oscpad$SvgSlider$update = F2(
	function (msg, model) {
		...
		switch (_p13.ctor) {
			case 'SvgPress':
				var _p14 = A2(_bburdette$oscpad$SvgSlider$getLocation, model, _p13._0);
				if (_p14.ctor === 'Ok') {
					return A3(
			...
			case 'SvgMoved':
				var _p16 = model.pressed;
				if (_p16 === true) {
					var _p17 = A2(_bburdette$oscpad$SvgSlider$getLocation, model, _p13._0);
					if (_p17.ctor === 'Ok') {
						return A3(_bburdette$oscpad$SvgSlider$updsend, model, _elm_lang$core$Maybe$Nothing, _p17._0);
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
	...
	return A3(
		...
		A3(
			...
			_bburdette$oscpad$SvgControl$CsSlider(
				A3(_bburdette$oscpad$SvgSlider$Spec, 'blah', _elm_lang$core$Maybe$Nothing, _bburdette$oscpad$SvgThings$Vertical)),
			_elm_lang$core$Maybe$Nothing));
};
